# 一、Spring Batch 介绍
推荐看到官网给的example, 大佬写的真的简洁，看了都很舒服，地址在Github: https://github.com/spring-projects/spring-batch/tree/main/spring-batch-samples/src/main/java/org/springframework/batch/sample  
