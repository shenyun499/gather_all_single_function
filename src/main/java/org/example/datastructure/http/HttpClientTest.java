package org.example.datastructure.http;

import org.example.datastructure.entity.AmlProcessAfterHitReqDTO;
import org.example.datastructure.entity.GenericDTO;
import org.example.datastructure.entity.GetNonStandardPersonAddrRspDTO;
import org.example.datastructure.entity.GetPersonAddrReqDTO;
import org.example.datastructure.json.JsonUtils;
...
public class HttpClientTest {
    ...
    public static String synHttpClientToOther(String result, String msgId) {
        ...
        //String org.example.datastructure.token = getWebUser(user).getToken();
        //if(org.example.datastructure.token!=null)post.addHeader("Authorization", "bearer "+org.example.datastructure.token);
        httpPost.setHeader("Content-Type", "application/org.example.datastructure.json;charset=UTF-8");
        String results = null;
        String parameter = JsonUtils.toJSON(reqDtos);
        try {
            StringEntity se = new StringEntity(parameter);
            se.setContentType("text/org.example.datastructure.json");
