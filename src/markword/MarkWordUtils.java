...
// 线程1
        ...
        new Thread(() -> {
            MarkWordUtils testBiasedLocking2 = new MarkWordUtils();
            for (int i = 0; i <= 500000; i++) {
                ...
                synchronized (MarkWordUtils.class) {
                    synchronized (testBiasedLocking2) {
                            System.out.println("第" + (i + 1) + "次加锁-线程1");

                            System.out.println(ClassLayout.parseInstance(testBiasedLocking2).toPrintable()); // 打印对象头信息
