...
//            if (xsdStream == null) {
//                KontException.throwKontException(MsgCdEnum.XSD_VALIDATE_FAIL, "FPS SDK alert: The verification of schema XSD is failed since missing the corresponding XSD definition file in " + xsdFilePath);
//            }
//            // 进入校验逻辑
